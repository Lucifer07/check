  ...
  return (
    <>
      ...
      <main className="h-screen w-full bg-black text-white">
        ...
        <div className="h-full xl:m-16 lg:m-16 px-2 flex-col justify-center">
          {successMessage && (
            <div className="rounded-md flex justify-center">
              <div className="text-white px-6 py-2 border-0 relative mb-4 mt-5 bg-blue-500 rounded-md text-sm">
